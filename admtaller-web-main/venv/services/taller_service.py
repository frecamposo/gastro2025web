...
# permite actualizar las observaciones de los productos de un taller de una asignatura
async def update_taller_asignatura_obs(id_producto: int, id_taller: int, observacion: str) -> Optional[dict]:

    # Armamos la URL de la API respectiva
    url = f"{APITaller.URL_BASE.value}/taller/producto/obs"
    producto = {
