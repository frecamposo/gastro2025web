...
#mio
async def deshabilitar_usuario(request: Request, id_usuario_deshabilitar: int) -> Optional[dict]:
    ...
    # Armamos la URL de la API respectiva
    url = f"{APITaller.URL_BASE.value}/usuario/deshabilitar/{id_usuario_deshabilitar}/{id_usuario}"
